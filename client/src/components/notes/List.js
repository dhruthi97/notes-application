                    ...
                    <tbody>
                        {
                           props.notes.map((note)=>{
                                return<tr key={note._id}>
                                        ...
                                        <td><Link to={`/notes/edit/${note._id}`}><button type="button" className="btn btn-primary">Edit</button></Link></td>
                                        <td><Link to={`notes/${note._id}`}><button type="submit" className="btn btn-primary">Show</button></Link></td>
